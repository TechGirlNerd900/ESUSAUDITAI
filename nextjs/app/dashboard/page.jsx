...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const timer3 = setTimeout(() => {
      ...
      loadProjects();
      loadNews();
    }, 1000); // Delay data loading to show beautiful UI first
        ...
        <div className={clsx(
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {/* Upload Files */}
              <div className="card-gradient hover:shadow-lg cursor-pointer transform transition-all duration-200 hover:scale-[1.02] group">
              ...
              <div className="card-gradient hover:shadow-lg cursor-pointer transform transition-all duration-200 hover:scale-[1.02] group">
                <div className="card-body text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900 mb-1">AI Chat</h3>
                  <p className="text-xs text-gray-600">Ask questions about audits</p>
                </div>
              </div>
              ...
              <div className="card-gradient hover:shadow-lg cursor-pointer transform transition-all duration-200 hover:scale-[1.02] group">
                <div className="card-body text-center">
                  ...
                  <p className="text-xs text-gray-600">Access generated reports</p>
                </div>
              </div>
              ...
              <div className="card-gradient hover:shadow-lg cursor-pointer transform transition-all duration-200 hover:scale-[1.02] group">
                <div className="card-body text-center">
                  ...
                  <p className="text-xs text-gray-600">Financial updates & trends</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                {/* Loading overlay for projects section */}
                {showLoadingOverlay && (
