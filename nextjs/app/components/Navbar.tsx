          ...
          <Menu as="div" className="relative">
            <Menu.Button className="-m-1.5 flex items-center p-1.5 hover:bg-gray-100 rounded-lg transition-all duration-200 group">
              ...
              <div className="relative">
                <svg
                  className="h-8 w-8 text-gray-400 group-hover:text-gray-600 transition-colors duration-200"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={1.5}
                  stroke="currentColor"
              ...
              <span className="hidden lg:flex lg:items-center">
                ...
                <svg
                  className="ml-2 h-4 w-4 text-gray-400 group-hover:text-gray-600 transition-colors duration-200"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
