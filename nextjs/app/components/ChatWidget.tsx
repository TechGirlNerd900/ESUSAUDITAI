  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content:
        "Hello! I'm Esus, your AI audit assistant. I can help you with audit procedures, compliance questions, risk assessment, and more. How can I assist you today?",
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      To use the AI chat feature, please configure your OpenAI API key in the
