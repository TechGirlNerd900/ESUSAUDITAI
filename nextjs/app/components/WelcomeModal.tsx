            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5-3H12M8.25 9h2.25"
                />
              </svg>
            ),
            variant: 'secondary' as const,
        ...
        {currentStep === 'tasks' && (
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Choose a task to get started with EsusAuditAI</p>
            </div>
