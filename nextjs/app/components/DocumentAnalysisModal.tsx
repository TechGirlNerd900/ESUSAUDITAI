              ...
              {!editMode ? (
                <>
                  <div className="mb-4">
                    ...
                    <pre className="bg-gray-50 p-2 rounded text-xs text-gray-700">
                ...
                >
                  <div>
                    <label htmlFor="custom-fields" className="block text-xs font-medium mb-1">
                      Custom Fields (JSON)
                    </label>
                    <textarea
                      id="custom-fields"
                  ...
                  <div>
                    <label htmlFor="tags-input" className="block text-xs font-medium mb-1">
