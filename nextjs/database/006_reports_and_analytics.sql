...
CREATE INDEX idx_audit_reports_organization_id ON audit_reports(organization_id, deleted_at) WHERE deleted_at IS NULL;
CREATE INDEX idx_audit_reports_project_id ON audit_reports(project_id, deleted_at) WHERE deleted_at IS NULL;
CREATE INDEX idx_audit_reports_status ON audit_reports(status, organization_id);
CREATE INDEX idx_audit_reports_type ON audit_reports(report_type, organization_id);
CREATE INDEX idx_audit_reports_created_by ON audit_reports(created_by, organization_id);
CREATE INDEX idx_audit_reports_approved_by ON audit_reports(approved_by, organization_id);
CREATE INDEX idx_audit_reports_parent ON audit_reports(parent_report_id) WHERE parent_report_id IS NOT NULL;
CREATE INDEX idx_audit_reports_period ON audit_reports(report_period_start, report_period_end, organization_id);
CREATE INDEX idx_audit_reports_published_at ON audit_reports(published_at, organization_id);
CREATE INDEX idx_audit_reports_tags ON audit_reports USING GIN(tags);
