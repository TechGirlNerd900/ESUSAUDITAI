...
import { addSearchFilters } from '@/lib/pagination';
...
export class Database {
  ...
  // Storage operations
  async getStorageUrl(bucket: any, path: any) {
    try {
      const {
        data: { publicUrl },
  ...
  async uploadFile(bucket: any, path: any, file: any) {
    try {
  ...
  async deleteFile(bucket: any, path: any) {
    try {
