...
CREATE INDEX idx_audit_reports_engagement_id ON audit_reports(engagement_id);
...
(
    gen_random_uuid(),
    'Nigerian Statutory Audit Report',
    'Standard statutory audit report template for Nigerian companies',
    'statutory',
    'Nigerian',
    ARRAY['Public Company', 'Private Company', 'SME'],
    '[
        {
            "id": "title_page",
            "title": "Title Page",
        ...
        },
        {
            ...
            "content": "We conducted our audit in accordance with International Standards on Auditing (ISAs). Our responsibilities under those standards are further described in the Auditor''s Responsibilities section of our report.",
            "order": 3,
            "isRequired": true,
            "templateVariables": {}
        },
        {
            ...
            "content": "Key audit matters are those matters that, in our professional judgment, were of most significance in our audit of the financial statements.",
            "order": 4,
            "isRequired": false,
            "templateVariables": {}
        },
        {
            ...
            "content": "Management is responsible for the preparation and fair presentation of the financial statements in accordance with Financial Reporting Standards, and for such internal control as management determines is necessary.",
            "order": 5,
            "isRequired": true,
            "templateVariables": {}
        }
...
(
    ...
    'Standard management letter template for internal control recommendations',
    'management',
    'ISA',
    ARRAY['All'],
    '[
        {
            "id": "introduction",
            "title": "Introduction",
            "content": "In connection with our audit of the financial statements of {{clientName}} for the year ended {{periodEnd}}, we identified certain matters that we believe warrant your attention.",
            "order": 1,
            "isRequired": true,
            "templateVariables": {}
        },
        {
            ...
            "content": "This management letter summarizes our observations and recommendations arising from our audit.",
            "order": 2,
            "isRequired": true,
            "templateVariables": {}
        },
        {
            ...
            "content": "Based on our audit procedures, we have identified the following areas for improvement:",
            "order": 3,
            "isRequired": true,
            "templateVariables": {}
        },
        {
            "id": "conclusion",
            "title": "Conclusion",
            "content": "We believe that implementing these recommendations will strengthen your internal control environment and improve operational efficiency.",
            "order": 4,
            "isRequired": true,
            "templateVariables": {}
        }
