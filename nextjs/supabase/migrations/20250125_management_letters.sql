...
BEGIN
    ...
    SET 
        ...
        reviewed_by = CASE WHEN new_status = 'review' THEN user_id ELSE reviewed_by END,
...
-- Insert default management letter templates
INSERT INTO management_letter_templates (
    id,
    name,
    description,
    letter_type,
...
(
    ...
    'Standard template for annual management letters',
    'annual',
    ARRAY['All'],
    '[
        {
            "id": "introduction",
            "title": "Introduction",
            "content": "In connection with our audit of the financial statements of {{clientName}} for the year ended {{periodEnd}}, we identified certain matters that we believe warrant your attention. These observations are intended to assist management in strengthening internal controls and improving operational efficiency.",
            "order": 1,
            "isRequired": true,
            "findingCategories": [],
            "templateVariables": {}
        },
        {
            ...
            "content": "The following sections present our detailed findings, along with recommendations for improvement:",
            "order": 2,
            "isRequired": true,
        ...
        },
        {
            ...
            "content": "To assist management in prioritizing the implementation of our recommendations, we have summarized the key actions below:",
            "order": 3,
            "isRequired": true,
            "findingCategories": [],
            "templateVariables": {}
        },
        {
            ...
            "content": "We believe that implementing these recommendations will strengthen your control environment and enhance operational effectiveness.",
            "order": 4,
            "isRequired": true,
            "findingCategories": [],
            "templateVariables": {}
    ...
    '{
        "version": "1.0",
        "createdDate": "2025-01-25T00:00:00Z",
        "author": "System",
...
-- Insert default finding templates
INSERT INTO management_letter_finding_templates (
    id,
    name,
    description,
    category,
...
(
    ...
    'Template for segregation of duties findings',
    'internal_control',
    'high',
    '{
        "title": "Inadequate Segregation of Duties",
        "description": "Insufficient segregation of duties in key financial processes",
        "currentSituation": "Our review identified instances where the same individual performs incompatible functions within the financial reporting process.",
        "risks": [
        ...
        "businessImpact": "This deficiency could result in material misstatements in financial reporting and increased risk of asset misappropriation.",
        "recommendation": "Implement proper segregation of duties by separating authorization, recording, and custody functions. Where segregation is not practical due to limited staff, implement compensating controls such as management review and approval."
    }',
    NULL,
    (SELECT id FROM auth.users LIMIT 1)
),
(
    ...
    'Template for documentation deficiency findings',
    'operational',
    'medium',
    '{
        "title": "Inadequate Documentation of Key Processes",
        "description": "Key business processes lack proper documentation",
        "currentSituation": "Several critical business processes are not adequately documented, creating dependency on key personnel and increasing operational risk.",
        "risks": [
        ...
        "businessImpact": "Lack of documentation increases operational risk and may impact business continuity.",
        "recommendation": "Develop comprehensive process documentation including flowcharts, procedures manuals, and checklists for all key business processes."
    }',
    NULL,
    (SELECT id FROM auth.users LIMIT 1)
);
