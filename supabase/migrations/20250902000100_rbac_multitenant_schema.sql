...
COMMENT ON FUNCTION public.search_audit_logs(UUID, VARCHAR(100), VARCHAR(20), TEXT, VARCHAR(50), VARCHAR(255), INTEGER, INTEGER) IS 'Searches audit logs with various filters for a given organization.';
