                ...
                <div className="relative z-10 text-white text-center">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-blue-100 text-lg">
                            Join the future of audit automation
                        </p>
                    </div>
                    ...
                    <div className="space-y-6 max-w-md mx-auto">
                        <div className="flex items-center text-left">
                            ...
                            <div>
                                <h3 className="font-semibold">Start as Auditor</h3>
                                <p className="text-sm text-blue-100">Begin with full auditor privileges immediately</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center text-left">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Leverage advanced AI for document processing</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center text-left">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Your data protected with bank-grade security</p>
                            </div>
                        </div>
                    </div>

                    <div className="mt-12 text-sm text-blue-200">
                        "Join thousands of audit professionals worldwide"
                    </div>
                </div>
            </div>
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-8">
                            Start your AI-powered audit journey today
                        </p>
                    </div>
