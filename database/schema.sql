...
-- Chat History table for Ask Esus feature
...
-- Application Settings table (moved from seed.sql for better organization)
...
-- Create function for password change tracking
...
-- Apply password change trigger
CREATE TRIGGER track_user_password_change BEFORE UPDATE ON users FOR EACH ROW EXECUTE FUNCTION track_password_change();